...
class ChangePasswordForm(forms.Form):
    ...
    password = forms.CharField(min_length=2, required=True, widget=forms.PasswordInput)
    password_confirm = forms.CharField(min_length=2, required=True, widget=forms.PasswordInput)
